...
interface SidebarProps {
  navGroups: NavGroup[];
  /** Subtítulo bajo "MIS VALES" (p. ej. el nombre del rol) */
  subtitle?: string;
}

export default function Sidebar({ navGroups, subtitle = "Sistema de Administración" }: SidebarProps) {
    ...
    <aside className="dashboard-sidebar">
      ...
      <div className="flex items-center gap-3 px-5 py-5 border-b border-white/10">
        ...
        <div>
          ...
          <p className="text-blue-200 text-[10px] mt-0.5 leading-none">{subtitle}</p>
        </div>
      </div>
